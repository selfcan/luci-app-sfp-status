...
var pageStyle = [
	'.agh-overview { --agh-ink:#1f2a55; --agh-muted:#66718f; --agh-line:#dbe3f0; --agh-panel:#ffffff; --agh-soft:#f4f7fb; --agh-blue:#5b6ee1; --agh-blue-dark:#4758c9; --agh-green:#1f9b62; --agh-red:#d84b63; display:grid; gap:18px; color:var(--agh-ink); }',
	'.agh-overview * { box-sizing:border-box; }',
	'.agh-head { display:grid; grid-template-columns:minmax(0,1fr) minmax(260px,320px); gap:18px; align-items:stretch; padding:20px; border-radius:22px; border:1px solid var(--agh-line); background:linear-gradient(135deg,#f8fbff 0%,#edf3fb 100%); box-shadow:0 18px 40px rgba(35,48,85,.08); overflow:hidden; }',
	'.agh-title-card { display:flex; flex-direction:column; justify-content:center; min-height:96px; padding:22px 24px; border-radius:18px; background:rgba(255,255,255,.72); border:1px solid rgba(219,227,240,.88); box-shadow:0 12px 26px rgba(35,48,85,.06); }',
	'.agh-title-card h2 { display:inline; align-self:flex-start; margin:0; padding:0; border:0; border-radius:0; background:transparent !important; box-shadow:none; font-size:2rem; line-height:1.15; font-weight:800; color:#151d4a; letter-spacing:0; }',
	'.agh-title-card p { margin:12px 0 0; max-width:760px; line-height:1.7; color:var(--agh-muted); }',
	'.agh-badges { display:flex; flex-wrap:wrap; gap:10px; margin-top:18px; }',
	'.agh-badge { display:inline-flex; align-items:center; gap:8px; min-height:30px; padding:6px 12px; border-radius:999px; border:1px solid var(--agh-line); background:rgba(255,255,255,.72); color:#34405f; font-size:13px; font-weight:700; }',
	...
	'.agh-core { padding:16px 18px; border-radius:16px; background:rgba(255,255,255,.74); border:1px solid var(--agh-line); }',
	...
	'.agh-actions .cbi-button-action { background:var(--agh-blue); border-color:var(--agh-blue); color:#fff; }',
	'.agh-metrics { display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:14px; }',
	'.agh-card { min-height:128px; padding:17px; border-radius:16px; border:1px solid var(--agh-line); background:var(--agh-panel); box-shadow:0 12px 30px rgba(35,48,85,.06); }',
	...
	'.agh-note { padding:14px 16px; border-radius:14px; background:#eef3fb; color:#495875; line-height:1.7; border:1px solid var(--agh-line); }',
