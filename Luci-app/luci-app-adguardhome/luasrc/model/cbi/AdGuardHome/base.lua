...
o.datatype="port"
o.optional = false
o.description = translate("Web console listens on this port and can be opened from the dashboard card above.")
...
local port=util.trim(luci.sys.exec("awk '/^[[:space:]]*port:/{printf($2);exit;}' "..util.shellquote(configpath).." 2>/dev/null"))
